...
const asociacionChoi = L.marker([-34.595508, -58.426375], { icon: redIcon }).addTo(mymap).bindPopup('<h2> Asociacion Choi</h2> <a href="https://vimeo.com/346124939"> <h3> Sabon = Master </h3> </a> <h5> Here is the central hub of the "Asociación de Alumnos de Nam Sung Choi" an association founded by the long-term practitioners with Sabon Nim Choi, Nam Sung who was one of the three pioneers of Taekwondo in Argentina. </h5> <img src="assets/sabon_master.png" width=400 height=253 /></a>', {
  className: 'custom-popup-class' // Add a custom class here
