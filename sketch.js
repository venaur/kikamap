...
blackHeart.bindTooltip('black Heart'); // hover text
...
gymGuido.bindTooltip('Gym Guido'); // hover text
...
triglav.bindTooltip('Triglav'); // hover text
...
campoMunicipal.bindTooltip('Campo Municipal'); // hover text
...
parroquia.bindTooltip('Parroquial'); // hover text
...
costaSalguero.bindTooltip('Costa Salguero'); // hover text
...
juventudCastelar.bindTooltip('Juventud Castelar'); // hover text
...
pedroEchague.bindTooltip('Pedro Echague'); // hover text
...
const medalWorkshop = L.marker([-34.568358, -58.594658], {icon: yellowIcon}).addTo(mymap);
      ...
      medalWorkshop.bindTooltip('Medal Workshop'); // hover text
